...
import UniversityExamForm from 'components/forms/exam/university-exam/university-exam.form';
...
function ExamPage({ extendedPageTitle }: Props) {
  ...
  const universityColumns = useMemo<MRT_ColumnDef<IExam>[]>(
    () => [
      ...
      {
        accessorKey: 'collegeDetails.year',
  ...
  return (
    <Box>
      <ExamTable
        ...
        permissionName="UniversityExams"
        extra={
          !subjectId && (
